...
public class RobotBootAutoB extends OpMode {

    Robot m_robot = null;

    public RobotBootAutoB()
    {
    ...
    public void init()
    {
        ...
        m_robot = new Robot(this.hardwareMap, this.telemetry, Robot.ROBOT_CONTROL_MODE.Autonomous,
                Robot.ROBOT_AUTONOMOUS_MODE.ModeB, Robot.ROBOT_TEAM_COLOR.Unknown);
    ...
    public void loop()
    {
        ...
        m_robot.Loop(gamepad1LeftStick, gamepad1RightStick, gamepad2.left_bumper, gamepad2.left_trigger,
                ...
                gamepad1.right_bumper, gamepad2.right_trigger);
    }
