...
public class RobotBoot extends OpMode {
    ...
    public void init()
    {
        ...
        m_robot = new Robot(this.hardwareMap, this.telemetry, Robot.ROBOT_CONTROL_MODE.Unknown,
                Robot.ROBOT_AUTONOMOUS_MODE.Unknown, Robot.ROBOT_TEAM_COLOR.Unknown);
    ...
    public void loop()
    {
        ...
        // gamepad1.left_bumper: intelligent break on (sensors down)
        // gamepad1.right_bumper: intelligent break off (sensors up)
        ...
        // gamepad2.dpad_up: center color paddle | deck up
        // gamepad2.dpad_down: execute color detection auto bump | deck down
        ...
        //TODO build telemetry collection and push data to phone here, then clear it
